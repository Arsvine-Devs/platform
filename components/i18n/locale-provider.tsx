...
import { DEFAULT_LOCALE, LOCALE_COOKIE, messages, resolveLocale, type AppLocale } from './messages';
...
export function LocaleProvider({ children, initialLocale = DEFAULT_LOCALE }: { children: ReactNode; initialLocale?: AppLocale }) {

...
const messages = {
  invalid_callback: {
    ...
    description:
      'This sign-in attempt is no longer valid. Start a fresh authorization request from Console.',
  },
  identity_claims_incomplete: {
    title: 'Account handoff incomplete',
    description:
      'Your identity was verified, but Console did not receive the required account role. Please try again.',
  },
  oidc_callback_failed: {
    title: 'Could not finish sign-in',
    description:
      'The authorization service returned an incomplete response. Start a new sign-in attempt.',
  },
} as const;

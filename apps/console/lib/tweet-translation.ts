...
function stripExplainForTranslation(content: string): string {
...
async function requestTranslation(params: { content: string; targetLocale: SiteTweetLocale }) {
...
export async function buildTweetTranslations(params: { content: string; sourceLang: TweetLang }) {
...
export function markTweetTranslationsStale(translations?: TweetItem['translations']) {
